...
# Local imports
from agents.BaseReflectionAgent import BaseReflectionAgent
from agents.prompts.PromptTemplateLoader import PromptTemplateLoader

class ProgrammerReflectionAgent(BaseReflectionAgent):
    '''
    ...
    def _get_agent(self) -> RunnableSequence:
        ...
        agent = (
            {  # how to get the variable values for the prompt template
                ...
                "tool_response":                lambda state: state["programmer_tool_response"],
    ...
    pass # end of ProgrammerReflectionAgent
